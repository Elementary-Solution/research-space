                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                        <ul class="breadcrumb breadcrumb-style ">
                            <li class="breadcrumb-item">
                                <h4 class="page-title"> Paper Type</h4>
                            </li>
                    ...
                    <div class="header">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <button type="button" class="btn btn-primary " data-toggle="modal"
                                    data-target="#exampleModal"> Add Paper Type
                            </button>
                            @include('management.OrderSettings.paper_type.add')
                        </div>
                    ...
                    <div class="body table-responsive">
                        <table class="table" id="myTable">
                            ...
                            <tr>
                                ...
                                <th class="col-lg-4">Paper Type</th>
                        ...
                        @include('management.OrderSettings.paper_type.edit')
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <form action="{{route('paper_type.destroy',$row->id)}}" method="post">
                                        @csrf
                                        @method('DELETE')
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content bg-danger">
                                                        ...
                                                        <div class="modal-body text-white">
                                                            Only Disabled paper type style will be deleted
                                                        </div>
                                                        <div class="modal-footer">
