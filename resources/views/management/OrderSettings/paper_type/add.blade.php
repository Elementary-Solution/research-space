        ...
        <div class="modal-content">
            <div class="create_questions">
                <div class="modal-header">
                    <h5 class="modal-title" id="formModal">Add Paper Type</h5>
            ...
            <div class="academic_level">
                ...
                <div class="modal-body">
                    <form action="{{route('paper_type.store')}}" method="post">
                        @csrf
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" id="email_address1"
                                       class="form-control" name="erp_paper_type"
            ...
            <div class="modal-footer">
                ...
                <button type="submit"
                        class="btn btn-info waves-effect">Create New Paper Type</button>
            </div>
                    </form>
