        ...
        <div class="modal-content">
            <div class="create_questions">
                <div class="modal-header">
                    <h5 class="modal-title" id="formModal">Add New Citation Style for Email</h5>
            ...
            <div class="academic_level">
                <div class="modal-body">
                    <form action="{{route('citation_style.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="erp_comment_text">
                            <div class="erp_comment_text">
                                ...
                                <textarea name="erp_citation_message"  class="form-control" id="erp_comment_text" cols="30" rows="10"></textarea>
                            </div>
                        </div>
                        <div class="file-field input-field">
                            ...
                            <div class="file-path-wrapper">
                                <input class="file-path validate" name="erp_file_type" type="text">
                            </div>
                        </div>
                        <label for="email_address1">Select timing of posting</label>
                        <div class="mt-4">
                            <div class="test">
                                <select class="form-control select2 " id="" name="erp_datetime" data-placeholder="Select">
                                    <option value="immediate">immediately</option>
                                    <option value="erp_date">Date & Time</option>
                                </select>
