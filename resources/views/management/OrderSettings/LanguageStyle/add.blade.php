        ...
        <div class="modal-content">
            <div class="create_questions">
                <div class="modal-header">
                    <h5 class="modal-title" id="formModal">Add Langauge Style</h5>
            ...
            <div class="academic_level">
                <div class="modal-body">
                    <form action="{{route('language_style.store')}}" method="post">
                        @csrf
                        ...
                        <label for="email_address1">Add Language Style Name:</label>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit"
                                    class="btn btn-info waves-effect">Create New Language Name</button>
                        </div>
                    </form>
                </div>
            </div>
