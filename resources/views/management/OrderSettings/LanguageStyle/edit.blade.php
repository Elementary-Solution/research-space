        ...
        <div class="modal-content">
            <div class="create_questions">
                <div class="modal-header">
                    <h5 class="modal-title" id="formModal">Edit Langauge Style</h5>
            ...
            <div class="academic_level">
                <div class="modal-body">
                    <form action="{{route('language_style.update',$row->id)}}" method="post">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" id="email_address1"  value="{{$row->erp_language_name}}"
                                       class="form-control" name="erp_language_name"
                                       placeholder="Type Langauge name Here">
                            </div>
                        </div>
                        <br>
                        {{--                                            <button type="button"--}}
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit"
                                    class="btn btn-info waves-effect">Update Language Name</button>
                        </div>
                    </form>
                </div>
            </div>
