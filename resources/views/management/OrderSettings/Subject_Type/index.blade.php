                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                        <ul class="breadcrumb breadcrumb-style ">
                            <li class="breadcrumb-item">
                                <h4 class="page-title"> Subject Type</h4>
                            </li>
                    ...
                    <div class="header">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <button type="button" class="btn btn-primary " data-toggle="modal"
                                    data-target="#exampleModal"> Add New Subject
                            </button>
                            @include('management.OrderSettings.Subject_Type.add')
                        </div>
                                ...
                                <tr>
                                    ...
                                    <button type="button" class="btn bg-blue btn-circle waves-effect waves-circle waves-float" data-toggle="modal" data-target="#exampleModal1{{$row->id}}">
                                        <i class="material-icons">edit</i>
                                         ...
                                         @include('management.OrderSettings.Subject_Type.edit')
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <form action="{{route('subject_type.destroy',$row->id)}}" method="post">
                                        @csrf
                                        @method('DELETE')
                                                 ...
                                                 <div class="modal-dialog modal-dialog-centered" role="document">
                                                     <div class="modal-content bg-danger">
                                                         ...
                                                         <div class="modal-body text-white">
                                                             Only Disabled Subject type will be deleted
                                                         </div>
                                                         <div class="modal-footer">
