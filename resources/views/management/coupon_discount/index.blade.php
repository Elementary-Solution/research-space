...
@section('title')
    Coupon Discount - {{config('app.dashboard')}}
@endsection
@section('content')
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    <div class="header">
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <a href="{{route('coupon-discount.create')}}" type="button" class="btn btn-primary"> Add
                                Coupon Discount
                            </a>
                        </div>
                        <div class="body table-responsive">
                            <table class="table" id="myTable">
                                ...
                                <tr>
                                    ...
                                    <th class="col-lg-3">Discount Code</th>
                                ...
                                $count = 1
                                ?>
                                @foreach($coupon_discount as $row)
                                    <tr>
                                        <td> {{$row->title}}</td>
                                        ...
                                        <td>
                                            <a class="btn bg-blue btn-circle"
                                               href="{{route('coupon-discount.show',$row->id)}}">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form action="{{route('coupon-discount.destroy',$row->id)}}"
                                                                  method="post">
                                                                @csrf
                                                                @method('DELETE')
