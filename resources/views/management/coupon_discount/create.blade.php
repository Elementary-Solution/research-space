...
@section('title')
    Coupon  Discount Create - {{config('app.dashboard')}}
    ...
    <div class="container-fluid px-4">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <form action="{{route('coupon-discount.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card py-4">
                                ...
                                <div class="header">
                                    ...
                                    <div class="row my-1">
                                        <div class=" col-12">
                                            ...
                                            <div class="form-line">
                                                <input value="{{old('discount_code') }}" type="text" id="discount_code"
                                    ...
                                    <div class="row my-1">
                                        <div class=" col-12">
                                            ...
                                            <div class="form-line">
                                                <input value="{{old('value') }}" type="text" id="value"
                                    ...
                                    <div class="row my-1">
                                        <div class=" col-12">
                                            ...
                                            <div class="form-line">
                                                <input value="{{old('expiry_date') }}" type="date" id="expiry_date"
