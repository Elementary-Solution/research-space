            ...
            <div class="card border-0 shadow rounded-3 p-4 mt-5">
                ...
                <div class="card-header bg-white border-0">
                    <div class="text-center">
                        <img width="150px" src="{{asset('management/images/logo.png')}}" alt="">
...
{{--                            <label for="password" class="col-md-12 col-form-label">{{ __('Password') }}</label>--}}
                            ...
                            <div class="col-md-6">
                                <div class="form-check p-0">
                                    @if (Route::has('password.request'))
                                        <a class="btn btn-link text-signature" href="{{ route('password.request') }}">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-8">
                                <button type="submit" class="btn bg-signature text-light">
                                    {{ __('Login') }}
                                </button>
                            </div>
                        </div>
